...
import { handleLoginGithub } from "./_actions/login-auth";
  ...
  return (
    <Card className="w-full border-none dark:bg-primary-main">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <Button
                variant="outline"
                title="Google"
                className="col-span-1 hover:bg-gradient-to-r from-chrome-red via-chrome-green to-chrome-yellow group/item"
              ...
              <Button
                variant="outline"
                title="Facebook"
                className="col-span-1 hover:bg-facebook-blue group/item"
              >
              ...
              <Button
                variant="outline"
                title="Github"
                className="col-span-1 hover:bg-twitter-blue group/item"
                onClick={handleLoginGithub}
              >
                <GithubIcon className="h-5 w-5 group-hover/item:text-white transition-colors" />
              </Button>
            </div>
          </div>
        </CardContent>
      ...
      <CardFooter className="w-full flex justify-between absolute bottom-0 right-0 h-auto py-4 px-4 border-none">
        ...
        <h3 className="text-sm text-text-secondary dark:text-foreground">
          Desenvolvido e mantido por ❤️
        </h3>
      </CardFooter>
    </Card>
  );
